...
export function generateRetentionPlaybook(args) {
    ...
    const generateIntervention = (reason) => {
...
function generateChurnDiscoveryKit(segment, businessModel, churnRate, severity, csTeamSize) {
    const commonReasons = {
...
function getSignalsForReason(reason) {
    const signals = {
...
function getInterventionForReason(reason) {
    const interventions = {
...
//# sourceMappingURL=retention-playbook.js.map