...
export function generateCompetitiveIntel(args) {
    ...
    const generateObjectionHandler = (objection) => {
...
function extractStrengthFromWin(win) {
...
function extractWeaknessFromLoss(loss) {
...
function generateCompetitiveDiscoveryKit(product, competitors) {
