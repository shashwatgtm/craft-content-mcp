...
export function generateNewsletter(args) {
    ...
    const config = segmentConfig[segment] || segmentConfig.general;
...
function generateSubjectLines(topic, type, segment) {
...
function generatePreviewText(subject, topic) {
...
function generateBodyContent(keyPoints, config, tone, type) {
    let content = '';
...
function generatePointContent(point, depth, tone) {
    const depthContent = {
...
function generateCtaSection(ctaGoal, segment) {
...
function getStructureRecommendation(type, segment) {
    const structures = {
        educational: `
...
function getSegmentTips(segment) {
    const tips = {
        executives: `
...
function getSendTimesForSegment(segment) {
    const times = {
...
function generateKeyPointsFromTopic(topic, type, segment) {
...
//# sourceMappingURL=newsletter-builder.js.map