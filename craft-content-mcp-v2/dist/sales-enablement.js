...
function generateLikelyObjections(product, priceContext) {
    const objections = [];
...
function generateObjectionHandler(objection, valueProps, proofPoints, priceContext) {
...
function generateCompetitorHandler(objection, valueProps, proofPoints) {
...
function generateStagePitch(stage, product, valueProps, persona, proofPoints) {
    const pitches = {
        prospecting: `
...
function deriveValuePropFromProof(proof) {
...
//# sourceMappingURL=sales-enablement.js.map