...
function getWebinarStructure(type, minutes) {
    const structures = {
        educational: [
...
function generateRunOfShow(structure, totalMinutes) {
    let currentTime = 0;
...
function generateScriptSection(section, topic, audience, takeaways, speakers, productLevel, includePolls) {
    const scripts = {
...
function generateAnticipatedQuestions(topic, takeaways, type) {
    return `
...
function generateTakeawaysFromTopic(topic, type, audience) {
    const typeSpecificTakeaways = {
        educational: [
...
//# sourceMappingURL=webinar-script.js.map