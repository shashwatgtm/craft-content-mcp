...
CRAFT Content is built and run by Shashwat Ghosh, Helix GTM Consulting. Contact: shashwat@gtmhelix.com.
...
The npm package `@shashwatgtmalpha/craft-content-mcp` runs entirely on your computer over stdio and sends nothing to us.
